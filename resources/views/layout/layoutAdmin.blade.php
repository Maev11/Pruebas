...
<header class="page-header">
  <nav>
    <a href="#0">
      <img class="logo" src="logo.png" alt="Laravel logo">
    </a>
...
<section class="page-content">
  <section class="search-and-user">
    ...
    <div class="admin-profile">
      <span class="greeting">Administrador</span>
  ...
  <footer class="page-footer">
    <small>Made with <span>❤</span> by <a href="https://www.instagram.com/mario_esponda1102/" target="_blank">Mario Alberto</a>
    </small>
  </footer>
</section>
